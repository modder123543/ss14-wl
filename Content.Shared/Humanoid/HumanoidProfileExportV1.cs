...
public sealed partial class HumanoidCharacterProfileV1
{
    ...
    {
        return new(Name, FlavorText, OocText, Species, TTSVoice, Age, Height, Sex, GetDefaultVoice(Species, Sex), Gender, Appearance.ToV2(Species), SpawnPriority, JobPriorities, PreferenceUnavailable, JobSubnames, AntagPreferences, TraitPreferences, new Dictionary<ProtoId<TraitPrototype>, int>(), Loadouts, JobUnblockings, MedicalRecord, SecurityRecord, EmploymentRecord, FullName, DateOfBirth, Confederation, Country, Skills); //WL-Changes; WL fiches; Language
    }
