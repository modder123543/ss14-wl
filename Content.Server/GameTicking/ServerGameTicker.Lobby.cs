...
public sealed partial class ServerGameTicker
{
    ...
    // TODO: You can move this to shared.
    // TODO: You *should* move this to shared >:)
    // TODO: If you are reading this, move this to shared!
    ...
    public bool PauseStart(bool pause = true)
    {
        ...
        if (pause)
        {
            _pauseTime = Timing.CurTime;
        }
        else if (_pauseTime != default)
        {
            _roundStartTime += Timing.CurTime - _pauseTime;
        }
