...
namespace Content.Server.GameTicking
{
    ...
    public sealed partial class ServerGameTicker
    {
        ...
        private async void PlayerStatusChanged(object? sender, SessionStatusEventArgs args)
        {
            ...
            if (Mind.TryGetMind(session.UserId, out var mindId, out var mind))
            {
            ...
            switch (args.NewStatus)
            {
                case SessionStatus.Connected:
                {
                    ...
                    if (firstConnection && Cfg.GetCVar(CCVars.AdminNewPlayerJoinSound))
                        Audio.PlayGlobal(new SoundPathSpecifier("/Audio/Effects/newplayerping.ogg"),
                ...
                case SessionStatus.InGame:
                {
                    ...
                    if (mind == null)
                    {
                        ...
                        Admin.Add(LogType.Connection, LogImpact.Low, $"User {args.Session:Player} attached to {(args.Session.AttachedEntity != null ? ToPrettyString(args.Session.AttachedEntity) : "nothing"):entity} connected to the game.");
                        break;
                    }
                ...
                case SessionStatus.Disconnected:
                {
                    ...
                    Admin.Add(LogType.Connection, LogImpact.Low, $"User {args.Session:Player} attached to {(args.Session.AttachedEntity != null ? ToPrettyString(args.Session.AttachedEntity) : "nothing"):entity} disconnected from the game.");
                    }
                    // Corvax-Queue-end
                    break;
                }
            ...
            {
                if (RoundId != 0 && RunLevel != GameRunLevel.PreRoundLobby)
                {
        ...
        public override void PlayerJoinGame(ICommonSession session, bool silent = false)
        {
            ...
            if (_adminManager.HasAdminFlag(session, AdminFlags.Admin))
            {
                ...
                {
                    // TODO: Try version of this method
            ...
            // TODO: We may not need to network this anymore >:D
