...
namespace Content.Server.GameTicking
{
    public sealed partial class ServerGameTicker
    {
            ...
            bool silent = false)
        {
            ...
            {
                Admin.Add(LogType.RoundStartJoin,
                    LogImpact.Medium,
            ...
            out string jobName)
        {
            ...
            var newMind = Mind.CreateMind(data.UserId, Name(mob));
            Mind.SetUserId(newMind, data.UserId);

            _playTimeTrackings.PlayerRolesChanged(player);

            Mind.TransferTo(newMind, mob);
        ...
        {
            Mind.WipeMind(player);
            Admin.Add(LogType.Respawn, LogImpact.Medium, $"Player {player} was respawned.");
        ...
        public void SpawnObserver(ICommonSession player)
        {
            ...
            if (mind == null)
            {
                ...
                var (mindId, mindComp) = Mind.CreateMind(player.UserId, name);
                mind = (mindId, mindComp);
                Mind.SetUserId(mind.Value, player.UserId);
                makeObserver = true;
            }
        ...
        public EntityCoordinates GetObserverSpawnPoint()
        {
            ...
            foreach (var map in Map.GetAllMapIds())
            {
